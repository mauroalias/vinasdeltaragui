        ...
        <div class="col-md-7">
            <form action="/contacto" method="POST" class="border p-4 rounded shadow-sm bg-white h-100">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="consulta" id="consulta" rows="4"
                        class="form-control @error('consulta') is-invalid @enderror">{{ old('consulta') }}</textarea>
